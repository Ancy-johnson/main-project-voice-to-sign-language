...
# Dataset phrases
PHRASES = ["thank you", "i love you", "keep calm and stay home", "miss you", "nice to meet you"]
...
def text_to_sign_language(text):
    ...
    # If no phrases matched, check word-by-word
    words = text.split()
    for word in words:
        video_path = os.path.join(sign_language_videos_path, f"{word}.mp4")
